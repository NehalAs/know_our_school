                          ...
                          child: ButtonTheme(
                            ...
                            child: TextButton(
                              onPressed: () {
                                ...
                                AppViewModel.get(context).getSchoolData();
                                if(state is AppGetDataSuccessState)
                                {
                                  schoolName=AppViewModel.get(context).schoolModel.schoolName!;
                                  schoolAddress=AppViewModel.get(context).schoolModel.schoolAddress;
                                  studentsNo=AppViewModel.get(context).schoolModel.numberOfStudents;
                                  teachersNo=AppViewModel.get(context).schoolModel.numberOfTeachers;
